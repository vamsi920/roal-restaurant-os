  ...
  it("detects synced ROAL tools and conversation-init webhook", () => {
    const summary = {
      tools: [
        ...
        { name: "sync_draft_order", id: "t2", op: "updated" as const },
        { name: "finalize_order", id: "t3", op: "updated" as const },
      ],
      tool_ids_on_agent: ["t1", "t2", "t3"],
    ...
    const snapshot = buildRestaurantLaunchChecklist({
      ...
      syncSummary: {
        tools: [
          ...
          { name: "sync_draft_order", id: "t2", op: "updated" },
          { name: "finalize_order", id: "t3", op: "updated" },
        ],
        tool_ids_on_agent: ["t1", "t2", "t3"],
        restaurant_placeholders_updated: true,
        first_message_updated: true,
